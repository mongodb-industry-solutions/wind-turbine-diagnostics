...
2. Once recording for all stages is complete, create an MongoDB Vector Search index on the `audio` database's `sounds` collection. Run the provided script from `api/`:
